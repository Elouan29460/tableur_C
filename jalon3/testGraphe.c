...
void test_graphe_simple() {
    ...
    // Réévaluer tous les successeurs
    reevaluate_successors(D3);
...
int main(void) {
    printf("=== Tests du graphe de dépendances ===\n");
